...
import com.jike.admin.model.AddGoodsDao;
import com.jike.admin.pojo.Goods;

/**
 * Servlet implementation class AddGoodsServlet
 */
@WebServlet("/AddGoodsServ")
public class AddGoodsServlet extends HttpServlet {

	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		Goods good = uploadImage(request, response);

		AddGoodsDao addgoods = new AddGoodsDao();
		int res = addgoods.addGoods(good);
	...
	private Goods uploadImage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
...
//					8 判定文件 类型 
						...
						fileItem.write(file);
//						9 /  拼接 图片 路径  保存到 数据库中 
						String url = "http://localhost:8080/demo2/goods/" + newFileName;
						goods.setImages(url);
