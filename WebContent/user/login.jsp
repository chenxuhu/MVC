		...
		<div class="loginLeft">
			<form action="" method="post" name="form1" class="form1">
				...
				<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email:<input
					...
					id="emailHint">请输入邮箱</span>
				</label><br /> <label>&nbsp;&nbsp;&nbsp;&nbsp;用户名:<input
					...
					value="" class="cpw" id="repassword" /><span>请输入重复密码</span>
				</label><br /> <label>&nbsp;&nbsp;&nbsp;&nbsp;验证码:</label><input
					type="text" value="" class="verification" id="inputVerifyCode" /><br />
			</form>
			<div class="register">
		...
		<div class="loginRight">
			<form action="" method="post" name="form2" class="form2">
				...
				<label>&nbsp;&nbsp;&nbsp;&nbsp;用户名:<input type="text"
					value="" class="myName" id="accountLogin" />
				</label><br /> <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;密码:<input
					type="password" value="" class="myPwd" id="passWordLogin" />
				</label><a href="javascript:void(0)">忘记密码？</a><br />
			</form>
